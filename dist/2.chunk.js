...
exports.default = {
	...
	filters: {
		filterBy: function filterBy(val) {
			var str = "";
			switch (val) {
				case "1":
					str = "已完善";break;
	...
	methods: {
		tjiao: function tjiao() {
			var arr = [];
			for (var i = 0; i < $(".circleBg").length; i++) {
				arr.push({ id: $(".circleBg").eq(i).attr("id") });
			}
			if (arr.length != 0) {
				console.log(arr);
				this.$router.push({
				...
				_$.myModal().flashInto("未选择参与人！");
				return;
			}
		},
		bgFn: function bgFn(e) {
			if (!$(e.target).attr("class") && $(e.target).attr("full") == 1) {
				$(e.target).attr("class", "circleBg");
			} else {
				$(e.target).attr("class", "");
			}
		},
		readyData: function readyData() {
			...
			_$.myAjax({
				...
				url: 'api/travel/travelcard/travelPersonList.json',
				data: {},
		...
		bindCard: function bindCard() {
			var me = this;
			if (me.data.cardNum == "" || me.data.pwd == "") {
				_$.myModal().flashInto("卡号或者密码不完整！");
				return;
			}
			_$.myAjax({
				modaltype: 1, //1为闪现框,2为自定义框
				url: 'api/travel/travelcard/cardBind.json',
				data: {
					couponId: me.data.cardNum,
					password: me.data.pwd
				},
				success: function success(str) {
					if (str.result.code == "1000") {} else {}
				}
			});
		}
	},
...
__vue_options__.__file = "C:\\Users\\panwenhua\\Documents\\HBuilderProject\\vue-CalendarListView\\src\\views\\travelInformation.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6d7d2e78"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d7d2e78", __vue_options__)
  } else {
    hotAPI.reload("data-v-6d7d2e78", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] travelInformation.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('nv-head', {
    ...
    staticClass: "tit"
  }, [_vm._v("请填写旅游者信息")]), _vm._v(" "), _c('ul', [_vm._l((_vm.items), function(item) {
    return [_c('li', [_c('span', {
      ...
      staticClass: "lastbtn"
    }) : _vm._e(), _vm._v(_vm._s(_vm._f("filterBy")(item.full))), _c('i')])], 1)])]
  })], 2)]), _vm._v(" "), _c('div', {
    staticClass: "travelCard"
  }, [_c('router-link', {
    staticClass: "tit",
    attrs: {
      "to": "/travelCard",
  ...
  }, [_vm._v("绑定旅游卡"), _c('i')]), _vm._v(" "), _vm._m(0)], 1), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("添加人员"), _c('i')])], 1), _vm._v(" "), _c('button', {
    staticClass: "btn",
    on: {
      "click": _vm.tjiao
    }
  ...
  return _c('div', {
    staticClass: "ticket"
  }, [_c('p', [_c('span', [_vm._v("旅游卡")]), _vm._v("限一张330元消费卷可使用")]), _vm._v(" "), _c('p', [_c('span', [_vm._v("旅游卡")]), _vm._v("限一张330元消费卷可使用")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-6d7d2e78", module.exports)
  }
}
